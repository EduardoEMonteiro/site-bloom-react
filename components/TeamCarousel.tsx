...
export const TeamCarousel: React.FC<TeamCarouselProps> = ({
    ...
    return (
        ...
        >
            ...
            >
                ...
                {showArrows && (
                    <>
                        <motion.button
                            onClick={() => paginate(-1)}
                            className="absolute left-5 top-1/2 transform -translate-y-1/2 bg-black/60 hover:bg-[#D4AF37] text-white w-12 h-12 rounded-full flex items-center justify-center z-20 transition-all duration-300 hover:scale-110 border-2 border-[rgba(255,248,175,0.3)] hover:border-[#D4AF37]"
                            whileTap={{ scale: 0.9 }}
                        >
                        ...
                        <motion.button
                            onClick={() => paginate(1)}
                            className="absolute right-5 top-1/2 transform -translate-y-1/2 bg-black/60 hover:bg-[#D4AF37] text-white w-12 h-12 rounded-full flex items-center justify-center z-20 transition-all duration-300 hover:scale-110 border-2 border-[rgba(255,248,175,0.3)] hover:border-[#D4AF37]"
                            whileTap={{ scale: 0.9 }}
                        >
            ...
            {/* Member Info (Bottom) - Hidden for portfolio */}
