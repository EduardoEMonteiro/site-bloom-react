...
const cardVariants = cva("absolute will-change-transform", {
  variants: {
    variant: {
      dark: "flex size-full flex-col items-center justify-center gap-6 rounded-2xl border border-stone-700/50 bg-[rgba(255,255,255,0.95)] p-6 backdrop-blur-xl shadow-2xl",
      light:
  ...
  (
    {
      arrayLength,
      index,
      incrementY = 25, // Increased from 10 to 25 for better spacing
      incrementZ = 10,
